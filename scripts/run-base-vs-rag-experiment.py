...
same immutable benchmark/retrieval inputs, invokes the same pinned Qwen3-8B
revision twice, and leaves both arms pending human/scorer review.
"""
...
def run_experiment(output_root: Path) -> Path:
    ...
    manifest = {
        "schema_version": "grow-doc-base-vs-rag-experiment-v1",
