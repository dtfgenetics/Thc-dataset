      ...
      <div className="issue-list">
        {filtered.map((item) => {
          ...
          <article key={item.id} className="issue-row">
            <div className="issue-thumb">{first?.thumbnailUrl ? <img src={first.thumbnailUrl} alt={first.alt} /> : first?.url ? <img src={first.url} alt={first.alt} /> : <ImagePlaceholder label={`No licensed reference image available for ${item.name}`} />}</div>
