...
describe('rankDifferentials', () => {
  ...
  it('ranks magnesium deficiency for its characteristic pattern without overstating confidence', () => {
  ...
  it('keeps viroid differentials low confidence until laboratory confirmation exists', () => {
